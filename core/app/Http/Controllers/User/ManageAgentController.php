...
class ManageAgentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user.agent.index', compact('pageTitle', 'emptyMessage', 'agents'));
    }
    ...
    public function pending()
    {
        ...
        return view('user.agent.index', compact('pageTitle', 'emptyMessage', 'agents', 'bloods'));
    }
    ...
    public function create()
    {
        ...
        $bloods = Blood::where('status', 1)->select('id', 'name')->get();
        return view('user.agent.create', compact('pageTitle', 'cities', 'bloods'));
    }
    ...
    public function agentBloodSearch(Request $request)
    {
        ...
        return view('user.agent.index', compact('pageTitle', 'emptyMessage', 'agents', 'bloods', 'bloodId'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('user.agent.index', compact('pageTitle', 'emptyMessage', 'agents', 'search'));
    }
    ...
    public function edit($id)
    {
        ...
        $bloods = Blood::where('status', 1)->select('id', 'name')->get();
        $cities = City::where('status', 1)->select('id', 'name')->with('location')->get();
        return view('user.agent.edit', compact('pageTitle', 'cities', 'bloods', 'agent'));
    }
    ...
    public function view($id)
    {
        ...
        $bloods = Blood::where('status', 1)->select('id', 'name')->get();
        $cities = City::where('status', 1)->select('id', 'name')->with('location')->get();
        return view('user.agent.view', compact('pageTitle', 'cities', 'bloods', 'agent'));
    }
