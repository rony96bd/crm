...
Route::namespace('Agent')->prefix('agent')->name('agent.')->group(function () {
    ...
    Route::middleware('agent')->group(function () {
        ...
        Route::post('profile', 'AgentController@profileUpdate')->name('profile.update');
        Route::get('password', 'AgentController@password')->name('password');
        Route::post('password', 'AgentController@passwordUpdate')->name('password.update');
...
Route::get('/', 'HomeController@index')->name('home');  //Using to set Homepage Default.
...
Route::get('/apply/agent', 'SiteController@applyAgent')->name('apply.agent');
Route::post('/apply/agent/store', 'SiteController@applyAgentstore')->name('apply.agent.store');
